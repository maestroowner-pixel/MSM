...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, Alert, ActivityIndicator, Switch, TouchableWithoutFeedback, Keyboard, Linking, Image, LayoutAnimation, Platform, UIManager } from 'react-native';
...
export default function SettingsSc() {
  ...
  return (
    <Screen scroll>
      ...
      <PlatformModal visible={resetVisible} transparent animationType="fade" onRequestClose={closeReset}>
