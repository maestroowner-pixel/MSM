...
const makeStyles = (COLORS: Palette) =>
  StyleSheet.create({
    ...
    // msm-logo.png is 2816×1536 (≈1.83:1). Size the box to that ratio (96×52) — rn-macos
    // ignores resizeMode="contain", so a square box vertically stretches the wide logo.
    logo: { width: 96, height: 52, marginTop: SIZES.sm, marginBottom: SIZES.md },
