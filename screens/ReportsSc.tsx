...
import { onDesktop } from '../utils/fileShare';
    ...
    <Screen scroll>
      ...
      {busy ? (
        ...
        <>
          ...
          {/* ZIP bundles each item's attached photos/docs — not available on desktop
              (no per-item attachment store), so hide it there. PDF/XLSX cover export. */}
          {!onDesktop && (
