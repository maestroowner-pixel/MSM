...
const styles = StyleSheet.create({
  ...
  // msm-logo.png is 2816×1536 (≈1.83:1). Size the box to that exact ratio (243×133) so
  // the cube is never distorted — react-native-macos doesn't honour resizeMode="contain"
  // on Animated.Image, so a square box would vertically stretch the wide logo.
  logo: { width: 243, height: 133, marginBottom: SIZES.xl },
